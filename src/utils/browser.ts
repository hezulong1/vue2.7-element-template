...
export const isSafari = !isChrome && /*@__PURE__*/ userAgent.indexOf('Safari') >= 0;
export const isEdge = /*@__PURE__*/ userAgent.indexOf('Edg/') >= 0;
export const isIE = /*@__PURE__*/ userAgent.indexOf('Trident') >= 0 || /*@__PURE__*/ userAgent.indexOf('MSIE') >= 0;
export const isIE11 = /*@__PURE__*/ userAgent.indexOf('Trident') >= 0 && /*@__PURE__*/ userAgent.indexOf('rv:11') >= 0;
