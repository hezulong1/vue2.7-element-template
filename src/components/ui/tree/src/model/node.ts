...
export const getChildState = (node: INode[]): TreeNodeChildState => {
  let all = true;
  let none = true;
...
const reInitChecked = function (node: INode): void {
...
const getPropertyFromData = function (node: INode, prop: string): any {
...
const setCanFocus = function (childNodes: INode[], focus: boolean): void {
